...
`GET` shows a form to edit a certain film. `POST` confirms editing a task and modifies the film in the database.

### Delete Page
Route: `/delete/{id}` (GET and POST)

`GET` shows a confirmation form to delete a certain film. `POST` confirms deleting a film and modifies the database.
...
## Screenshots
### Home
![](https://i.imgur.com/rVKCIaY.png)
![](https://i.imgur.com/4AnMed8.png)
### Create
![](https://i.imgur.com/dKxT7mf.png)
### Edit
![](https://i.imgur.com/zpgsN0F.png)
### Delete
![](https://i.imgur.com/jH78j17.png)
